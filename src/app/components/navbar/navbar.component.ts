...
export class NavbarComponent implements OnInit {
    ...
    searchDialogIsOpen: boolean = false;
    ...
    openSearchDialog(): void {
        ...
        if (!this.searchDialogIsOpen) {
            const openSearchDialog = this.dialog.open(SearchDialogComponent, window.innerWidth < 776 ? {
                maxWidth: '100vw',
                maxHeight: '100vh',
                height: '100%',
                width: '100%',
